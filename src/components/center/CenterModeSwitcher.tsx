...
import { Map as MapIcon, Video, Radar, Radio, BarChart3, TrendingUp } from "lucide-react";

export type CenterMode = "signals" | "videos" | "map" | "live" | "polls" | "trends";
...
> = {
  ...
  trends: { label: "TRENDS", Icon: TrendingUp, accent: "#ea580c", bg: "bg-orange-500/10", border: "border-orange-500/25" },
};
...
export function CenterModeSwitcher({
  ...
  const modes: CenterMode[] = showLive ? ["live", "signals", "videos", "map", "polls", "trends"] : ["signals", "videos", "map", "polls", "trends"];
  return (
